		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comcrudodatacapmodatacrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcrudodatacapmodatacrud-display": {
								"semanticObject": "comcrudodatacapmodatacrud",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.crudodata.capmodatacrud",
									"url": sap.ui.require.toUrl("com/crudodata/capmodatacrud")
								}
							}
						}
					}
